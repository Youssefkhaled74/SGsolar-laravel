...
return [
    ...
    'testimonials' => [
        [
            'name' => 'علي سعيد',
            'message' => 'الشغل كان مرتب من أول يوم، والفريق خلّص التركيب في وقت قياسي. الكومباني خلصت كل حاجة من غير ما نغطي شمسنا.',
            'rating' => 5,
        ],
        [
            'name' => 'مروة عبد الله',
            'message' => 'الخطوات كانت واضحة، وبعتوا لي كل التفاصيل والضمان في ورقة واحدة. كمان الدعم بعد التسليم كان سريع.',
            'rating' => 4,
        ],
        [
            'name' => 'محمد الزهراني',
            'message' => 'الشغل بتاعهم صح من الآخر، النظام وفرلي كهربا كتير ونفسيتي مع السخانات عمرها ما كانت أحسن.',
            'rating' => 5,
        ],
        [
            'name' => 'هنا شمس',
            'message' => 'شخصيًا من أول مكالمة لحد الاستلام حسّيت إننا بنتعامل مع ناس فاهمين ومهتمين، وسخانات الطاقة الشمسية بتشتغل تمام.',
            'rating' => 4,
        ],
        [
            'name' => 'أحمد فاروق',
            'message' => 'تجربة ممتازة من البداية للنهاية. الفريق محترف جداً والمنتجات عالية الجودة. فعلاً استثمار يستحق كل قرش.',
            'rating' => 5,
        ],
        [
            'name' => 'سارة محمود',
            'message' => 'راضية جداً عن الخدمة والمتابعة المستمرة. السخان الشمسي شغال بكفاءة عالية وتوفير ملحوظ في الفواتير.',
            'rating' => 5,
        ],
    ],
