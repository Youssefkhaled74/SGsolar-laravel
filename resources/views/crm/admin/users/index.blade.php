...
<style>
    ...
    .users-header h2{margin:0;font-size:18px;font-weight:900;color:rgba(255,255,255,.92)}
    .users-header .hint{font-size:13px;font-weight:800;color:rgba(255,255,255,.62);margin-top:4px}
    ...
    .toast .close{background:transparent;border:none;cursor:pointer;font-weight:900;opacity:.85;color:rgba(255,255,255,.9)}
    ...
    .modal-head h3{margin:0;font-size:16px;font-weight:900;color:rgba(255,255,255,.92)}
    .modal-head .sub{font-size:13px;font-weight:800;color:rgba(255,255,255,.62);margin-top:4px}
    .modal-close{
        border:1px solid rgba(255,255,255,.14);
        background: rgba(255,255,255,.04);
        color: rgba(255,255,255,.90);
    ...
    .alert-error{border-color:rgba(239,68,68,.25);background:rgba(239,68,68,.10);color:#ffd0d0}
    .tip{font-size:12px;font-weight:800;color:rgba(255,255,255,.62);margin-top:6px}

    /* Form grid */
    .form-grid{display:grid;grid-template-columns:1fr;gap:10px}
    @media(min-width:640px){.form-grid{grid-template-columns:1fr 1fr}}
    .full{grid-column:1 / -1}
    .field-label{font-size:12px;color:rgba(255,255,255,.62);font-weight:900;margin-bottom:6px}
            ...
            <div class="users-header">
                <div>
                    <div class="count-pill" style="margin-bottom:10px">
                        ...
                        Total Users: <strong style="color:rgba(255,255,255,.92)">{{ $users->count() }}</strong>
                    </div>
