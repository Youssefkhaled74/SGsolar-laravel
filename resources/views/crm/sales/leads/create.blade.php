...
<style>
    ...
    .label{
        ...
        font-size:12px;font-weight:900;color:rgba(255,255,255,.70);
        margin-bottom:6px;
    }
    .tag{
    ...
    .help{margin-top:6px;font-size:12px;font-weight:800;color:rgba(255,255,255,.58);line-height:1.35}
    ...
    .err{margin-top:6px;font-size:12px;font-weight:800;color:#ffd0d0}
