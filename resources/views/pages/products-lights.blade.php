            ...
            <div class="products-grid">
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <h4 class="product-english-name" style="color: #666; font-size: 0.9em; margin-top: 5px;">{{ $product['english_name'] }}</h4>
                        @endif
                        @if(!empty($product['power']))
                        <p class="product-power">{{ $product['power'] }}</p>
                        @endif
                        
                        <div class="product-full-content" style="white-space: pre-line; line-height: 1.8; margin: 15px 0;">
                            {{ $product['full_content'] ?? $product['description'] }}
                        </div>

                        <div class="product-actions">
                            @if(isset($product['datasheet']))
                            <button class="btn-product btn-download-pdf" onclick="showDownloadForm('{{ $product['datasheet'] }}', '{{ $product['name'] }}')">
